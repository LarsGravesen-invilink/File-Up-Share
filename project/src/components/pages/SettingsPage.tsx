          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-white/8 bg-white/5 px-3 py-2.5 text-sm text-white outline-none focus:border-cyan-500/30"
              />
              <button
