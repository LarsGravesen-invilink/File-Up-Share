    ...
    <div className="space-y-5">
      ...
      >
        ...
        <p className="mb-3 text-[11px] text-white/20">
          Бот скрывает панель по команде /close и восстанавливает по /open.
          Аварийное восстановление: unlock-my-panel
        </p>
        <div className="flex items-center justify-between rounded-lg bg-white/3 px-4 py-3">
          <div className="text-xs text-white/50">Включить режим невидимки</div>
